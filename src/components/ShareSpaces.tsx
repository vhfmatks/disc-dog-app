// 지도 맨 아래의 공유 서랍.
//
// 공유는 **양방향**이고, **이미 제출된 결과까지 전부** 넘어갑니다. 그래서 이 화면의
// 문구가 기능의 절반입니다 — 버튼을 누르는 사람은 두 가지를 알아야 합니다:
//   1. 자기 스페이스의 결과도 상대에게 넘어간다 (맞교환)
//   2. 지금까지 제출된 사람들 것까지 넘어간다 (소급)
// 둘 중 하나라도 모르고 누르면 남의 데이터를 잘못 내보내는 겁니다.
//
    ...
    <section className="share-panel">
      ...
      {panel === 'list' && (
        <div className="card share-list-card">
          ...
          <h3>다른 스페이스와 함께보기</h3>
          <p className="small muted">
            상대가 수락하면 <b>서로의 지도</b>에 함께 뜹니다. <b>양쪽의 기존 참가자까지
            전부</b> 보입니다 — 이미 제출한 사람들은 이 공유를 모르고 냈다는 걸 감안해
            주세요. 넘어가는 건 닉네임과 강아지 유형뿐이고, 상대가 우리 설문에 참가하거나
            발자국을 찍을 수는 없습니다 — 그러려면 우리 초대 링크나 비밀번호가 있어야 합니다.
          </p>
